...
public abstract class Square implements Comparable<Square> {
	...
	public static Square[] getSquares(MonopolyBoard board) {
		...
		squares[11] = new Property("St.Charles Place", Color.MAGENTA, 140, 10, 50, 150, 450, 625, 750, 100);
		squares[12] = new Utility("Electric Company");
		squares[13] = new Property("States Avenue", Color.MAGENTA, 140, 10, 50, 150, 450, 625, 750, 100);
		...
		squares[26] = new Property("Atlantic Avenue", Color.YELLLOW, 260, 22, 110, 330, 800, 975, 1150, 150);
		squares[27] = new Property("Ventnor Avenue", Color.YELLLOW, 260, 22, 110, 330, 800, 975, 1150, 150);
		squares[28] = new Utility("Water Works");
		squares[29] = new Property("Marvin Gardens", Color.YELLLOW, 280, 24, 120, 360, 850, 1025, 1200, 150);
